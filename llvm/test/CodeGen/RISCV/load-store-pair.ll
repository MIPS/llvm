...
; RV32I_PAIR-NEXT:    lw s5, 8(a0)
; RV32I_PAIR-NEXT:    lw s4, 12(a0)
; RV32I_PAIR-NEXT:    #APP
...
; RV32D_PAIR-NEXT:    lw s5, 8(a0)
; RV32D_PAIR-NEXT:    lw s4, 12(a0)
; RV32D_PAIR-NEXT:    #APP
...
; RV64D_PAIR-NEXT:    addi sp, sp, 32
; RV64D_PAIR-NEXT:    ret
; RV64D_I8500-LABEL: testi:
; RV64D_I8500:       # %bb.0: # %entry
; RV64D_I8500-NEXT:    addi sp, sp, -32
; RV64D_I8500-NEXT:    .cfi_def_cfa_offset 32
; RV64D_I8500-NEXT:    sdp s3, s2, 16(sp) # 16-byte Folded Spill
; RV64D_I8500-NEXT:    sdp s5, s4, 0(sp) # 16-byte Folded Spill
; RV64D_I8500-NEXT:    .cfi_offset s2, -8
; RV64D_I8500-NEXT:    .cfi_offset s3, -16
; RV64D_I8500-NEXT:    .cfi_offset s4, -24
; RV64D_I8500-NEXT:    .cfi_offset s5, -32
; RV64D_I8500-NEXT:    ld s3, 0(a0)
; RV64D_I8500-NEXT:    ld s2, 8(a0)
; RV64D_I8500-NEXT:    ld s5, 16(a0)
; RV64D_I8500-NEXT:    ld s4, 24(a0)
; RV64D_I8500-NEXT:    #APP
; RV64D_I8500-NEXT:    #NO_APP
; RV64D_I8500-NEXT:    ldp s3, s2, 16(sp) # 16-byte Folded Reload
; RV64D_I8500-NEXT:    ldp s5, s4, 0(sp) # 16-byte Folded Reload
; RV64D_I8500-NEXT:    addi sp, sp, 32
; RV64D_I8500-NEXT:    ret
entry:
...
; RV64I_8500:       # %bb.0: # %entry
; RV64I_8500-NEXT:    flw ft1, 8(a0)
; RV64I_8500-NEXT:    flw ft0, 12(a0)
; RV64I_8500-NEXT:    flw ft3, 0(a0)
; RV64I_8500-NEXT:    flw ft2, 4(a0)
; RV64I_8500-NEXT:    fmv.x.w a0, ft2
; RV64I_8500-NEXT:    fmv.x.w a1, ft0
; RV64I_8500-NEXT:    fmv.x.w a2, ft1
; RV64I_8500-NEXT:    fmv.x.w a3, ft3
...
; RV64D_I8500-LABEL: testf:
; RV64D_I8500:       # %bb.0: # %entry
; RV64D_I8500-NEXT:    flw fa2, 8(a0)
; RV64D_I8500-NEXT:    flw fa1, 12(a0)
; RV64D_I8500-NEXT:    flw fa3, 0(a0)
; RV64D_I8500-NEXT:    flw fa0, 4(a0)
; RV64D_I8500-NEXT:    tail sinkf
entry:
...
; RV32I_PAIR:       # %bb.0: # %entry
; RV32I_PAIR-NEXT:    lw a6, 0(a0)
; RV32I_PAIR-NEXT:    lw a7, 4(a0)
; RV32I_PAIR-NEXT:    lw a4, 16(a0)
; RV32I_PAIR-NEXT:    lw a5, 20(a0)
; RV32I_PAIR-NEXT:    lw a2, 24(a0)
; RV32I_PAIR-NEXT:    lw a3, 28(a0)
; RV32I_PAIR-NEXT:    lw a1, 12(a0)
...
; RV64I_8500:       # %bb.0: # %entry
; RV64I_8500-NEXT:    ld a2, 16(a0)
; RV64I_8500-NEXT:    ld a1, 24(a0)
; RV64I_8500-NEXT:    ld a3, 0(a0)
; RV64I_8500-NEXT:    ld a0, 8(a0)
...
; RV64D_I8500-LABEL: testd:
; RV64D_I8500:       # %bb.0: # %entry
; RV64D_I8500-NEXT:    fld fa2, 16(a0)
; RV64D_I8500-NEXT:    fld fa1, 24(a0)
; RV64D_I8500-NEXT:    fld fa3, 0(a0)
; RV64D_I8500-NEXT:    fld fa0, 8(a0)
; RV64D_I8500-NEXT:    tail sinkd
entry:
