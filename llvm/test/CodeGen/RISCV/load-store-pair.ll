...
; RUN: llc -mtriple=riscv64 -mcpu p8700 -mattr=+load-store-pairs -riscv-load-store-pairs=1 -verify-machineinstrs < %s \
...
; RV32I_PAIR-NEXT:    lw t0, 8(a0)
; RV32I_PAIR-NEXT:    lw a1, 12(a0)
; RV32I_PAIR-NEXT:    mv a0, t0
