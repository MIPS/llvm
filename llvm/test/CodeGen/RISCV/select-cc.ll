...
; RV64I-CCMOV-NEXT:    ccmov a0, a4, a2, a0
; RV64I-CCMOV-NEXT:    lw a2, 0(a1)
; RV64I-CCMOV-NEXT:    xor a4, a0, a3
; RV64I-CCMOV-NEXT:    ccmov a0, a4, a0, a3
; RV64I-CCMOV-NEXT:    lw a3, 0(a1)
; RV64I-CCMOV-NEXT:    sltu a4, a2, a0
; RV64I-CCMOV-NEXT:    ccmov a0, a4, a0, a2
; RV64I-CCMOV-NEXT:    lw a2, 0(a1)
; RV64I-CCMOV-NEXT:    sltu a4, a0, a3
; RV64I-CCMOV-NEXT:    ccmov a0, a4, a3, a0
; RV64I-CCMOV-NEXT:    lw a3, 0(a1)
...
; RV64I-CCMOV-NEXT:    slt a3, a2, a3
; RV64I-CCMOV-NEXT:    lw a4, 0(a1)
; RV64I-CCMOV-NEXT:    ccmov a0, a3, a0, a2
; RV64I-CCMOV-NEXT:    sext.w a2, a0
; RV64I-CCMOV-NEXT:    lw a3, 0(a1)
; RV64I-CCMOV-NEXT:    slt a2, a2, a4
; RV64I-CCMOV-NEXT:    ccmov a0, a2, a4, a0
; RV64I-CCMOV-NEXT:    sext.w a2, a0
; RV64I-CCMOV-NEXT:    slt a2, a2, a3
; RV64I-CCMOV-NEXT:    lw a4, 0(a1)
; RV64I-CCMOV-NEXT:    ccmov a0, a2, a0, a3
; RV64I-CCMOV-NEXT:    lw a2, 0(a1)
; RV64I-CCMOV-NEXT:    sext.w a3, a0
; RV64I-CCMOV-NEXT:    slt a3, a4, a3
; RV64I-CCMOV-NEXT:    ccmov a0, a3, a4, a0
; RV64I-CCMOV-NEXT:    slti a3, a2, 1
; RV64I-CCMOV-NEXT:    lw a4, 0(a1)
; RV64I-CCMOV-NEXT:    ccmov a0, a3, a0, a2
; RV64I-CCMOV-NEXT:    lw a3, 0(a1)
